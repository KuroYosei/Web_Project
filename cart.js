...
(function() {
  ...
  document.querySelector(".cart").addEventListener("click", function(){
    document.querySelector(".for_background").style.display="block";
    document.querySelector('.buy-product-btn').style.display ="block";
    document.querySelector(".shopping-cart-container").style.display = "block";
  })
  document.querySelector(".for_closing_cart").addEventListener("click", function(){
    document.querySelector(".for_background").style.display="none";
    document.querySelector("#no_product").innerHTML = " ";
  })
  ...
  function checkout() {
    ...
    if (cartProducts !== "") {
      ...
      buyyes.addEventListener("click" ,function(e){
          document.querySelector('.buy-product-btn').style.display = "None";
          document.querySelector('.lds-default').style.display ="inline-block";
          document.querySelector('#cart-display').innerHTML ="Loading";
            
        setTimeout(() => {
          document.querySelector('#cart-display').innerHTML ="Delivery will start soon....";
      ...
      document.querySelector('.checkout').style.display ="none";
      document.querySelector('#no_product').innerHTML = "There is NO product in cart!!";
      return;
    }
  }
...
for (let i = 0; i < productsContainer.length; i++) {
  ...
  checkoutBtn.addEventListener("click", function(e) {
    ...
    document.querySelector('#cart-display').innerHTML ="Do You Want to Buy Now?";
    e.preventDefault();
    checkout();
  });
