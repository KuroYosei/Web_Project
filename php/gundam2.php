...
<body>
      ...
      <div>
          ...
          <li><a href="gundam.php">Gundam Models</a>
              ...
              <li><a href="#">About Us</a></li>
                    ...
                    <li><a href="#"><button id="mobilebutton">Log-in</button></a></li> href="#"><button id="mobilebutton">Log-in</button></a></li>
  ...
  <div>
    ...
    <div class="row">
      <div class="column">
        <img src="./gundam2.1.png" alt="Nature" style="width:100%" onclick="myFunction(this);">
      </div>
      <div class="column">
        <img src="./gundam2.1.png" alt="Snow" style="width:100%" onclick="myFunction(this);">
      </div>
      <div class="column">
        <img src="./gundam2.3.png" alt="Mountains" style="width:100%" onclick="myFunction(this);">
      </div>
      <div class="column">
        <img src="./gundam2.4.png" alt="Lights" style="width:100%" onclick="myFunction(this);">
      </div>
    </div>
    ...
    <div class="detail">
      ...
      <dl>
        <dt>product name</dt>
        <dd>PG 00 Gundam Seven Sword/G</dd>

        <dt>series</dt>
        <dd> Gundam 00 (Double O)</dd>
