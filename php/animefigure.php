...
<body class="grid_allocation">
            ...
            <header class="header">
                ...
                <div>
                    <ul id="navbar">
                        ...
                        <li><a href="animefigure.php" class="active">Anime Figure</a>
                        ...
                        <li class="mobile-btn"><a href="login.php" class="login-btn"><button id="mobilebutton">Log-in</button></a></li>
                    </ul>
                </div>
                <div id="mobile">
    ...
    <div class="grid_body">
        ...
        <?php
        $select = mysqli_query($conn, "SELECT * FROM product WHERE productType = 'AnimeFigure'");
        ?>
