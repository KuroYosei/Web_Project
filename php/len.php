...
<body>
  ...
  <div>
    ...
    <div class="row">
      <div class="column">
        <img src="./len-1.webp" alt="Nature" onclick="myFunction(this);">
      </div>
      <div class="column">
        <img src="./len-2.webp" alt="Snow" onclick="myFunction(this);">
      </div>
      <div class="column">
        <img src="./rin-3.webp" alt="Mountains" onclick="myFunction(this);">
      </div>
      <div class="column">
        <img src="./rin-4.webp" alt="Lights" onclick="myFunction(this);">
      </div>
    </div>
    ...
    <div class="detail">
      ...
      <dl>
        <dt>product name</dt>
        <dd>Nendoroid Kagamine Len: Harvest Moon Ver.</dd>
