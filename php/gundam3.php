...
<body>
      ...
      <div>
          <ul id="navbar">
              ...
              <li><a href="animefig.php" >Anime Figure</a>
                <ul class="P1drop">
                  <li><a href="./albedo.php">albedo</a></li>
                  <li><a href="./rin.php">rin</a></li>
                  <li><a href="./len.php">len</a></li>
                  <li><a href="#">luxt</a></li>
              </ul>
          </li>
          <li><a href="gundam.php">Gundam Models</a>
              <ul class="P1drop">
                  <li><a href="./gundam1.php">g-1</a></li>
                  <li><a href="./gundam2.php">g-2</a></li>
                  <li><a href="./gundam3.php">g-3</a></li>
                  <li><a href="#">g-4</a></li>
              </ul>
          </li>
  ...
  <div>
    ...
    <div class="row">
      <div class="column">
        <img src="./gundam3.1.jpg" alt="Nature" style="width:100%" onclick="myFunction(this);">
      </div>
      <div class="column">
        <img src="./gundam3.2.jpg" alt="Snow" style="width:100%" onclick="myFunction(this);">
      </div>
      <div class="column">
        <img src="./gundam3.3.jpg" alt="Mountains" style="width:100%" onclick="myFunction(this);">
      </div>
      <div class="column">
        <img src="./gundam3.4.jpg" alt="Lights" style="width:100%" onclick="myFunction(this);">
      </div>
    </div>
    ...
    <div class="detail">
      ...
      <dl>
        <dt>product name</dt>
        <dd>ENTRY GRADE Strike Gundam</dd>
